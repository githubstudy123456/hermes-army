...
These pre-date the K-quant variants and are generally not recommended unless compatibility requires it:

| Type | Bits | Description |
|------|------|-------------|
| Q4_0 | 4-bit | Basic 4-bit, no delta encoding |
| Q4_1 | 4-bit | 4-bit with delta encoding, slightly better |
| Q5_0 | 5-bit | Basic 5-bit |
| Q5_1 | 5-bit | 5-bit with delta encoding |

**K-quant methods (Q4_K_M, Q5_K_M, etc.) are recommended over legacy types** for better quality at the same bit width.
