...
=== Skill 猎人报告 === 2026-06-01 ===

[推荐1] agentic-workflow-automation
链接: clawhub.ai/agentic-workflow-automation
核心功能: 生成可复用的多步骤 Agent 工作流蓝图，支持触发/动作编排、确定性工作流定义和自动化交接。
亮点: 匹配度 3.235，适合构建复杂自动化流程；MIT-0 许可证免费使用。

[推荐2] cipher-market-research
链接: clawhub.ai/cipher-market-research
核心功能: 市场情报分析师——竞争分析、定价研究、市场规模、趋势报告，每项数据均有来源支撑。
亮点: 匹配度 0.933，适合投资研究/市场分析场景；数据有出处保证质量。

[推荐3] ai-productivity-assistant
链接: clawhub.ai/ai-productivity-assistant
核心功能: 批量生成视频图片客户端助手，通过对话驱动本地客户端生成视频和图片，支持飞书、QQ、微信等入口。
亮点: 匹配度 1.873，支持多平台内容生成；随时随地可触发，无需守在电脑前。
