...
=== Skill 猎人报告 === 2026-06-17 ===

[推荐1] cipher-market-research
链接: clawhub.ai/cipher-market-research
核心功能: 市场情报分析师 — 竞争分析、定价调研、市场规模、趋势报告，每项结论均有数据支撑并注明来源
匹配度: 0.473
亮点: MIT-0 许可证可直接商用，覆盖竟品分析+定价+市场估算完整链路，适合投资/战略部门

[推荐2] nexus-market-researcher
链接: clawhub.ai/nexus-market-researcher
核心功能: 战略市场研究智能体 — 竞争分析、市场规模、定价情报，识别 EdTech 等行业商业机会
匹配度: 0.470
亮点: v2.1.1 版本成熟，支持跨行业商业机会识别，MIT-0 许可证

[推荐3] system-data-intelligence-skill
链接: clawhub.ai/system-data-intelligence-skill
核心功能: 操作系统级数据智能 — Excel/WPS/Word/TXT 文件处理 + 深度数据分析 + 专业可视化图表生成
匹配度: 1.081
亮点: 触发式场景覆盖全面，跨应用数据流处理，含数据可视化与图表报告生成，适用日常运营分析
