...
=== Skill 猎人报告 === 2026-06-07 ===

[推荐1]
Skill名称: playwright-browser-automation
链接: https://clawhub.ai/playwright-browser-automation
核心功能: Playwright 浏览器自动化，可导航网站、交互元素、提取数据、截图、生成PDF/视频
亮点: 匹配度 2.590（最高），MIT-0 免费，版本 2.0.0，浏览器自动化比 MCP 更可靠

[推荐2]
Skill名称: cipher-market-research
链接: https://clawhub.ai/cipher-market-research
核心功能: 市场情报分析 — 竞品分析、定价调研、市场规模、趋势报告，每条结论有数据支撑
亮点: 匹配度 0.502，适合投资研究/市场分析场景

[推荐3]
Skill名称: content-generation
链接: https://clawhub.ai/content-generation
核心功能: 多格式内容生成 — 文章、报告、社交媒体帖子、营销文案
亮点: 匹配度 0.489，MIT-0 免费，内容创作者必备
