...
=== Skill 猎人报告 === 2026-06-08 ===

代理状态：不可用（超时），ClawHub 搜索正常

---

[推荐1] system-data-intelligence-skill
链接: clawhub.ai/zhaojie911272507/system-data-intelligence-skill
功能: 操作系统级数据分析和可视化 — Excel/WPS/Word/TXT/Markdown 文件读写、跨应用数据抓取、深度分析、图表生成、仪表盘报告
亮点: 匹配度 1.154（最高），强制触发场景覆盖文件操作+数据分析+可视化三大高频需求，内含避坑指南

[推荐2] sql-database-toolkit
链接: clawhub.ai/sqlskills/sql-database-toolkit
功能: SQL 数据分析全家桶 — 数据库/文件连接、SQL 查询、AI 洞察、图表可视化、报告仪表盘生成
亮点: 匹配度 0.552，MIT-0 许可证免费使用，一站式覆盖从连接数据库到生成报告的全链路

[推荐3] cipher-market-research
链接: clawhub.ai/renoblabs/cipher-market-research
功能: 市场情报分析师 — 竞品分析、定价调研、市场规模估算、趋势报告，所有结论均有数据来源支撑
亮点: 匹配度 0.502，MIT-0 免费，适合投资研究/市场调研场景
