...
=== Skill 猎人报告 === 2026-06-02 ===

[推荐1] agentic-workflow-automation
链接: clawhub.ai/agentic-workflow-automation
功能: 生成可复用的多步 Agent 工作流蓝图，触发/动作编排，确定性工作流定义
亮点: MIT-0 免费，专注 Agent 编排模式，可用于 lobster 军团自动化任务编排

[推荐2] ai-workflow-automation
链接: clawhub.ai/ai-workflow-automation
功能: AI 工作流自动化专家技能，帮助用户自动化重复任务，使用 OpenClaw skills 和多 Agent 编排
亮点: MIT-0 免费，tag 完整(agent/automation/workflow)，适合工作流自动化落地

[推荐3] nexus-market-researcher
链接: clawhub.ai/nexus-market-researcher
功能: 战略市场研究 Agent，进行竞争分析、市场规模、定价情报、商业机会识别
亮点: v2.1.1 最新版，覆盖 EdTech 等多领域，适合市场情报分析

[推荐4] geepers-orchestrate
链接: clawhub.ai/geepers-orchestrate
功能: 通过 dr.eamer.dev 编排 API 运行多 Agent Dream Cascade（分层3层合成）或 Dream Swarm（并行多域搜索）工作流
亮点: 分层/并行双模式，适合复杂研究任务分解
