...
=== Skill 猎人报告 === 2026-05-20 ===

[推荐1] productivity (clawhub.ai/productivity)
功能：通用效率操作系统 — 整合能量管理、时间块、目标管理、项目/任务/习惯追踪、优先级排序、复盘机制。
亮点：评分 4.400（全场最高），覆盖完整个人效率闭环，开箱即用。

[推荐2] dev-productivity-bundle (clawhub.ai/dev-productivity-bundle)
功能：开发者效率套装 — AI 代码审查 + Bug 追踪 + 文档生成 + 部署监控四大能力。
亮点：专为程序员设计，自动化 Code Review + 智能化 Bug 管理，匹配 lobster-dev 角色。

[推荐3] cipher-market-research (clawhub.ai/cipher-market-research)
功能：市场情报分析师 — 竞品分析、定价研究、市场规模估算、趋势报告，所有结论均有数据来源。
亮点：弥补现有公司调研报告缺乏竞品横向对比的短板，适合 lobster-ceo / lobster-cfo。
