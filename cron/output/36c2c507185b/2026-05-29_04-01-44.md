...
=== Skill 猎人报告 === 2025-05-29 ===

[推荐1] khoj
功能：AI second brain — 自托管知识库，支持从网页/本地文档问答、构建定制Agent、调度自动化、做深度研究
亮点：支持主流LLM（GPT/Claude/Gemini/Llama/Qwen/Mistral），可本地部署，自动化R&D流程，star 34.7k

[推荐2] dify
功能：生产级 Agentic Workflow 开发平台
亮点：star 143k，TS/Node技术栈，工作流编排+Agent开发，当前最热的开源AI工作流平台

[推荐3] RD-Agent
功能：AI驱动的研发自动化Agent，聚焦数据驱动AI的R&D流程
亮点：微软开源，star 13.2k，专为提升工业生产力设计，适合科研/数据团队

[备选] activepieces
功能：AI Agents + MCP + 工作流自动化平台，内置~400 MCP服务器
亮点：star 22.5k，开源，对标n8n但更侧重AI Agent原生集成

---
备注：代理（10809端口）不可用，改用 GitHub API 搜索高星仓库替代 ClawHub 向量搜索。
