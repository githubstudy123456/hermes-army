...
=== Skill 猎人报告 === 2026-06-11 ===

[推荐1] productivity
链接: clawhub.ai/productivity
核心功能: 能量管理+时间块+目标+项目+任务+习惯+复盘的系统化效率框架
亮点: MIT-0免费，兼容最新1.0.4版本，覆盖计划/执行/复盘全链路

[推荐2] ai-productivity-audit
链接: clawhub.ai/ai-productivity-audit
核心功能: 审计用户当前AI工具栈，按ROI评分，识别冗余和升级机会
亮点: 1.1.0版本，结构化报告输出，适合优化团队AI工作流

[推荐3] productivity-automation-kit
链接: clawhub.ai/productivity-automation-kit
核心功能: 效率自动化工具箱 — 工作流模板+日程管理+任务提醒+数据整理自动化
亮点: 中文触发词，自动化流程+省时工具，适合行政/运营部门

备注：代理(10809)本次不可用，clawhub向量搜索部分成功。情报/营销方向搜索无结果返回，productivity类搜索命中率最高。
