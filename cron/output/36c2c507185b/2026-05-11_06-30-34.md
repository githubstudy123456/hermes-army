...
=== Skill 猎人报告 === 2026-05-11 ===

[推荐1] ai-meeting-notes
功能：AI会议笔记工具，支持从混乱笔记中提取行动项、分配负责人和截止日期，自动生成可搜索的待办清单
亮点：无需机器人/订阅/配置，直接粘贴笔记即可出行动项；MIT-0免费许可证

[推荐2] ai-web-automation
功能：自动化网页任务（填表/爬虫/测试/监控/定时任务），支持多浏览器和重试机制
亮点：覆盖浏览器自动化全场景，适合QA和运营自动化

[推荐3] competitive-intelligence
功能：基于二手研究生成竞品分析报告和差异化话术
亮点：匹配度1.055（最高），直接产出可用的竞争分析文档
