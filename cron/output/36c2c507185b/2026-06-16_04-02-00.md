...
=== Skill 猎人报告 === 2026-06-16 ===

[推荐1] cipher-market-research (@renoblabs)
功能：市场情报分析 — 竞品分析、定价调研、市场规模、趋势报告，每条结论均有数据来源支撑。
亮点：匹配度0.502，竞争分析框架完整，适合投研/市场部门直接使用。

[推荐2] system-data-intelligence-skill (@zhaojie911272507)
功能：操作系统级深度数据分析 — Excel/WPS/Word/TXT跨文件抓取、趋势研究、异常检测、图表可视化生成。
亮点：匹配度高达1.103，覆盖数据提取→分析→可视化全链路，是本次搜索最高分结果。

[推荐3] sql-database-toolkit (@sqlskills)
功能：SQL数据分析和可视化工具包 — 支持数据库/文件连接、SQL查询、AI洞察、报告/仪表盘生成。
亮点：匹配度0.525，可直接对接SQL数据库生成可视化报表，适合数据分析师。
